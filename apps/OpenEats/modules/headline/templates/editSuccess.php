...
<?php echo form_tag('headline/update') ?>
...
<div id="headlinebody"><p><b>Intro: </b></p><?php echo object_textarea_tag($sf_data->getRaw('headline'), 'getHeadlineIntro', 'cols=80 rows=35 rich=fck')?></div>
