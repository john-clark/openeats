...
abstract class BaseCoursePeer {
	...
	const COURSE_NM = 'course.COURSE_NM';

	
	const COURSE_DESC = 'course.COURSE_DESC';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('CourseId', 'CourseNm', 'CourseDesc', ),
		BasePeer::TYPE_COLNAME => array (CoursePeer::COURSE_ID, CoursePeer::COURSE_NM, CoursePeer::COURSE_DESC, ),
		BasePeer::TYPE_FIELDNAME => array ('COURSE_ID', 'COURSE_NM', 'COURSE_DESC', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('CourseId' => 0, 'CourseNm' => 1, 'CourseDesc' => 2, ),
		BasePeer::TYPE_COLNAME => array (CoursePeer::COURSE_ID => 0, CoursePeer::COURSE_NM => 1, CoursePeer::COURSE_DESC => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('COURSE_ID' => 0, 'COURSE_NM' => 1, 'COURSE_DESC' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CoursePeer::COURSE_ID);

		$criteria->addSelectColumn(CoursePeer::COURSE_NM);

		$criteria->addSelectColumn(CoursePeer::COURSE_DESC);

	}

	const COUNT = 'COUNT(course.COURSE_ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT course.COURSE_ID)';
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(CoursePeer::COURSE_ID); 
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(CoursePeer::COURSE_ID);
			$selectCriteria->add(CoursePeer::COURSE_ID, $criteria->remove(CoursePeer::COURSE_ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(CoursePeer::COURSE_ID, (array) $values, Criteria::IN);
		}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(CoursePeer::COURSE_ID, $pk);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(CoursePeer::COURSE_ID, $pks, Criteria::IN);
